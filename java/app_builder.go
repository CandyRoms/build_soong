...
func CreateAndSignAppPackage(ctx android.ModuleContext, outputFile android.WritablePath,
	packageFile, jniJarFile, dexJarFile android.Path, certificates []Certificate, deps android.Paths, v4SignatureFile android.WritablePath, candyFile android.Path) {
	...
	SignAppPackage(ctx, outputFile, unsignedApk, certificates, v4SignatureFile, candyFile)
}

func SignAppPackage(ctx android.ModuleContext, signedApk android.WritablePath, unsignedApk android.Path, certificates []Certificate, v4SignatureFile android.WritablePath, candyFile android.Path) {
	...
	if candyFile != nil {
		flags = append(flags, "--candy", candyFile.String())
		deps = append(deps, candyFile)
	}
